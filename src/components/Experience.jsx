     ...
     return (
        <section id="experience" className="pt-0 pb-section px-6 max-w-screen-xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-32">
                <div>
                    <h2 className="text-5xl md:text-7xl lg:text-8xl text-foreground font-ogg tracking-tighter mb-8 leading-none select-none">Experience</h2>
                ...
                <div className="space-y-12 mt-12 md:mt-0">
                    {[
                        ...
                        <div key={i} className="group interactive">
                            <div className="flex justify-between items-end border-b border-zinc-900 pb-4 mb-4 font-ogg transition-colors">
                                <h4 className="text-2xl text-foreground font-ogg font-normal tracking-tight transition-colors">{job.company}</h4>
                                <span className="text-xs text-foreground font-mono">{job.period}</span>
                            </div>
                            <p className="text-sm text-accent font-chakra font-normal">{job.role}</p>
                        </div>
                    ))}
                </div>
            </div>
